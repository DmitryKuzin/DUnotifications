...
<#macro clearBodyTemplate title="Car selection service | Best-Car" styles=[] scripts=[]>
<!DOCTYPE html>
...
<div class="hidden">
    <form action="" id="login">
        ...
        <div class="inp-wr">
            <input class="js_in" type="text" placeholder="Имя пользователя" required="required">
            <div class="line"></div>
        </div>
        <div class="inp-wr">
            <input class="js_in2" type="password" placeholder="Пароль" required="required">
            <div class="line"></div>
        </div>
